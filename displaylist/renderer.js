...
(function (render) {
    ...
    var DisplayObject = (function () {
        ...
        DisplayObject.prototype.draw = function (context) {
            ...
            if (!parent) {
                ...
                this.globalMatrix = matrixMatrix(localMatrix, parent.globalMatrix); //子本地乘以父全局
            }
    ...
    function matrixMatrix(m1, m2) {
        var result1 = new render.Matrix();
        result1.a = m1.a * m2.a + m1.b * m2.c;
        result1.b = m1.a * m2.b + m1.b * m2.d;
        result1.c = m2.a * m1.c + m2.c * m1.d;
        result1.d = m2.b * m1.c + m1.d * m2.d;
        result1.tx = m2.a * m1.tx + m2.c * m1.ty + m2.tx;
        result1.ty = m2.b * m1.tx + m2.d * m1.ty + m2.ty;
        return result1;
    }
    var imagePool = {};
